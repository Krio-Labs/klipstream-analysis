#!/bin/bash
# Script to run Hugging Face transcript analysis

# Check if video ID is provided
if [ -z "$1" ]; then
    echo "Usage: $0 <video_id> [batch_size]"
    echo "Example: $0 2434635255 10"
...
# Run analysis
echo "Running Hugging Face transcript analysis for video $VIDEO_ID..."

# Build command
CMD="python huggingface_transcript_analysis.py --input_file \"$INPUT_FILE\" --output_file \"outputs/audio_${VIDEO_ID}_paragraphs_hf.csv\" --text_column \"text\""
